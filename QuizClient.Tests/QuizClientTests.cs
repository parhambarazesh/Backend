...
public class QuizClientTests : IClassFixture<QuizServiceApiPact>
{
    ...
    [Fact]
    public void CalculateScoreForStudent_WhenQuizzesExist_ReturnsScore()
    {
        // Arrange
        var quizzes = new List<Quiz>
            {
                new Quiz {Id = 123, Title = "This is quiz 123"},
            };
        var questions =new List<Question>
        {
            new Question {Id = 1, QuizId = 123, Text = "This is question 1", CorrectAnswerId = 1},
            new Question {Id = 2, QuizId = 123, Text = "This is question 2", CorrectAnswerId = 2},
            new Question {Id = 3, QuizId = 123, Text = "This is question 3", CorrectAnswerId = 3},
            new Question {Id = 4, QuizId = 123, Text = "This is question 4", CorrectAnswerId = 4}
        };
        var answers=new List<Answer>
        {
            new Answer {Id = 1, QuestionId = 1, Text = "This is answer 1"},
            new Answer {Id = 2, QuestionId = 1, Text = "This is answer 2"},
            new Answer {Id = 3, QuestionId = 2, Text = "This is answer 3"},
            new Answer {Id = 4, QuestionId = 2, Text = "This is answer 4"}
        };
        var consumer = new QuizClient(_mockProviderServiceBaseUri, Client);
        var result = consumer.CalculateScoreForStudent(123, "John", questions, answers);
    ...
    public async Task GetQuizzes_WhenSomeQuizzesExists_ReturnsTheQuizzes()
    {
        var expectedQuizzes = new List<Quiz>
            {
                new Quiz {Id = 123, Title = "This is quiz 123"},
                new Quiz {Id = 124, Title = "This is quiz 124"}
            };
